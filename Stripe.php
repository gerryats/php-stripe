...
class Stripe {
	 ...
	 * @param  string  Three-letter ISO currency code, in lowercase. Must be a supported currency.
	 ...
	 */
	public function plan_create( $id = NULL, $currency, $interval, $product, $amount = NULL, $interval_count = NULL, $metadata = NULL, $nickname = NULL) {
		$params = array(
			'currency' => $currency,
			'interval' => $interval,
			'product' => $product
